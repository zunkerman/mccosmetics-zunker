package io.lumine.cosmetics.nms.v1_18_R1.wardrobe;
...
public class MannequinEntity implements Mannequin {
    ...
    private final VolatileCodeEnabled_v1_18_R1 handler;
    ...
    public MannequinEntity(WardrobeTracker tracker, VolatileCodeEnabled_v1_18_R1 handler, Player player, Location location) {
